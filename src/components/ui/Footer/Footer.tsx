...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative overflow-hidden text-foreground bg-[#0a1426]">
      <div className="py-12 lg:py-16 xl:py-20 ">
        ...
        <div className="absolute bottom-0 left-[-5%] ">
          <Image
            src="https://infoteknextjs.vercel.app/assets/img/footer-shape-1.png"
            alt="Elfedge"
            width={360}
            height={370}
          />
        ...
        <div className="absolute bottom-0 right-[-3%] ">
          <Image
            src="https://infoteknextjs.vercel.app/assets/img/footer-shape-2.png"
            alt="Elfedge"
            width={288}
            height={383}
          />
        ...
        <div className="container relative z-10 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          >
            <Link
              href="/"
              className="inline-block text-2xl xl:text-3xl mb-3 font-bold whitespace-nowrap text-primary font-rajdhani w-full h-auto max-w-[140px] sm:max-w-[180px] xl:max-w-[180px]"
            >
              <Image
            ...
            <p className="text-sm sub-title text-left leading-relaxed mb-4 lg:mb-6 xl:mb-8 font-inter font-normal max-w-md">
            ...
            <div className="flex space-x-2">
              {[
                {
                  href: "https://www.facebook.com/Elfedge",
                  Icon: FaFacebook,
                },
                {
                  href: "https://www.instagram.com/Elfedge",
                  Icon: FaInstagram,
                },
                { href: "https://www.x.com/Elfedge", Icon: FaXTwitter },
                {
                  href: "https://www.linkedin.com/company/Elfedge",
                  Icon: FaLinkedin,
                },
                { href: "https://www.github.com/Elfedge", Icon: FaGithub },
              ].map(({ href, Icon }, idx) => (
                <Link
                  key={idx}
                  href={href}
                ...
                >
                  <Icon className="h-6 w-6 md:w-5 md:h-5 lg:w-6 lg:h-6 text-white transform transition-transform group-hover:scale-110" />
                </Link>
              ))}
            </div>
          </motion.div>
            ...
            <ul className="space-y-3 text-sm">
              {quickLinks.map(({ name, href }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-white transition-colors hover:text-primary text-base font-space-grotesk font-normal"
                  >
                    {name}
                  </Link>
                </li>
          ...
          >
            ...
            <p className="text-sm text-primary-foreground font-inter font-normal">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              <div className="flex flex-col gap-3 mb-3">
                ...
                >
                  ...
                  <span className="text-sm lg:text-base text-primary-foreground font-space-grotesk font-normal">
                    +91 8851967714
                  </span>
                </Link>
                <Link
                  href="mailto:Elfedgetech@gmail.com"
                  className="text-sm font-normal flex items-center gap-2 lg:gap-4"
                >
                  <Mail className="size-4 md:size-5" />
                  <span className="text-sm lg:text-base text-primary-foreground font-space-grotesk font-normal">
                    Elfedgetech@gmail.com
                  </span>
                </Link>
                <Link
                  href="#"
      ...
      <div className="bg-primary py-10 sm:py-6">
        ...
        <div className="container text-sm text-muted-foreground flex flex-col sm:flex-row gap-y-4 md:flex-row justify-between items-center relative">
          ...
          <p className="text-sm lg:text-base font-normal text-primary-foreground">
            &copy; {currentYear} Elfedge. All rights reserved.
          </p>
