...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center font-inter relative font-medium rounded-full overflow-hidden transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-none",
  {
    variants: {
      /**
